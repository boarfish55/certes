...
# signing authorities.
mkdir -p $basedir/authority1/certs $basedir/authority1/trust_store
...
cat $basedir/ca/root.pem $basedir/authority1/cert.pem > $basedir/proxy1/ca.pem
...
cat $basedir/ca/root.crl \
	$basedir/authority1/authority1.crl > $basedir/proxy1/ca.crl
