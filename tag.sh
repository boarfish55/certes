...
if [ "$RESP" = "y" -o "$RESP" = "Y" ]; then
	...
	sed -i "s/^\(VERSION =[ \t]*\)[0-9][0-9]*\.[0-9][0-9]*\.[0-9][0-9]*$/\\1$major.$minor.$patch/" openbsd-ports/misc/certes/Makefile
	git add Makefile GNUmakefile openbsd-ports/misc/certes/Makefile
